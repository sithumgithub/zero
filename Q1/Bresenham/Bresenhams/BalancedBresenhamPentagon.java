...
public class BalancedBresenhamPentagon extends JFrame {
    private int[] xPoints;
    private int[] yPoints;

    public BalancedBresenhamPentagon() {
        setTitle("Balanced Bresenham Pentagon Drawing");
        setSize(400, 400);
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> {
            BalancedBresenhamPentagon balancedPentagon = new BalancedBresenhamPentagon();
            balancedPentagon.setVisible(true);
        });
    }
}
